    ...
    return (
        <>
            <section className="home_hero">
                <img className="hero_image" src={Hero} alt="Tattoo artist at work - Guestme platform hero image"/>
